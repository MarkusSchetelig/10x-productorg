...
export const consultingAreas = [
  ...
  },
  {
    ...
    description: "Engineering the trusted, interoperable data backbone. Build a scalable, governed data foundation (lakehouse/mesh + streaming + vector) with strong contracts, semantics, and privacy-by-design to power analytics, ML, and agents.",
    icon: "Database",
    color: "#7c3aed",
